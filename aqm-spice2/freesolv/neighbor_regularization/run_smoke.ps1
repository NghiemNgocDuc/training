...
# Runs: (out_rel, extra_args, log_name)
$runs = @(
    @("baseline/lambda0_seed42",    @("--lambda_nbr", "0"),             "baseline_lambda0_seed42"),
    @("raw/lambda0.001_seed42",     @("--lambda_nbr", "0.001"),         "raw_lambda0.001_seed42"),
    @("raw/lambda0.01_seed42",      @("--lambda_nbr", "0.01"),          "raw_lambda0.01_seed42"),
    @("normalized/lambda0.1_seed42", @("--lambda_nbr", "0.1", "--normalize_nbr"), "normalized_lambda0.1_seed42"),
    @("normalized/lambda1.0_seed42", @("--lambda_nbr", "1.0", "--normalize_nbr"), "normalized_lambda1.0_seed42")
)
