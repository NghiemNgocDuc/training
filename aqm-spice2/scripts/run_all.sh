...
echo "===== 1. Clone repo ====="
if [ ! -f "aqm-spice2/pipeline/train_stage1_vacuum.py" ]; then
    if [ ! -d "training" ]; then
...
RESULTS="aqm-spice2/pipeline/results"
mkdir -p "$RESULTS"

echo "===== 5. Stage 1: Vacuum (quick) — DONE, SKIPPING ====="
# $PYTHON -c "import torch; torch.cuda.empty_cache()"
# $PYTHON aqm-spice2/pipeline/train_stage1_vacuum.py \
#     --hdf5 AQM-gas.hdf5 \
...
# $PYTHON -c "import torch; torch.cuda.empty_cache()"
# $PYTHON aqm-spice2/pipeline/train_stage2_correction.py \
#     --hdf5 AQM-sol.hdf5 \
...
# $PYTHON -c "import torch; torch.cuda.empty_cache()"
# $PYTHON aqm-spice2/pipeline/train_option_a.py \
#     --hdf5 AQM-sol.hdf5 \
...
# $PYTHON -c "import torch; torch.cuda.empty_cache()"
# $PYTHON aqm-spice2/pipeline/train_stage2b_explicit.py \
...
echo "===== 9. Evaluate ====="
$PYTHON aqm-spice2/pipeline/evaluate_model.py \
