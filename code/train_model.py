...
parser.add_argument('-ra','--radius',default=2.0,type=float,help='radius') # the default is 0.6 in ML-GN but it seems too small for our data.
...
trainer = Trainer(verbose=False,name='GNN3_pub_' + model_inf_string,path='trained_models',force_mode=True,enable_tmp_dir=False,random_state=args.random, lr=args.lr)
