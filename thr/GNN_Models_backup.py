...
class GNN_GBNeck(torch.nn.Module):
    def __init__(self, radius=0.6, max_num_neighbors=32, parameters=None, device=None, jittable=False,unique_radii=None):
        '''
    ...
    def build_graph(self, data):
        ...
        # Get Radius Graph
        graph = self._grapher(data)#data.pos, data.atomic_features
